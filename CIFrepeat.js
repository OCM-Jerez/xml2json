...
const dataInitial = require("./todo102021NoRepeatOk.json");
...
function question() {
    ...
    createFile("./resultados/todoAdjudicatarias102021.json", adjudicatarias);
    createFile("./resultados/todo102021NoRepeatOkCIFOK.json", dataInitial);
}
