...
class SearchRepeat {
	saveResultRepeat(dataInitial, listRepeat, listNoRepeat, listRepeatMajor, monthSelected) {
		...
		// const pathRepeat = "C:/Users/Usuario/Mi unidad/OCM/Plataforma de contratacion del sector publico/Datos abiertos/Tratados con searchRepeat.js/2024/" + monthSelected;
		const pathRepeat =
			'C:/Users/Usuario/OneDrive/OCM/Plataforma de contratacion del sector publico/Datos abiertos/Tratados con searchRepeat.js/2024/' +
			monthSelected;
		...
		commonInstance.createFile(`${pathRepeat}/repeat${monthSelected}2024.json`, listRepeat);
		commonInstance.createFile(`${pathRepeat}/repeatMajor${monthSelected}2024.json`, listRepeatMajor);
		commonInstance.createFile(`${pathRepeat}/todo${monthSelected}2024NoRepeatOK.json`, listNoRepeat);
	...
	logFinal(pathRepeat, monthSelected, dataInitial, listRepeat, listRepeatMajor, listNoRepeat) {
		...
		commonInstance.createFile(`${pathRepeat}/logFinal${monthSelected}2024.json`, logFinal);
	}
}
